...
# You can comment out the Ruby example after your AR is working. 
  ...
  it '4. finds orders of multiple amounts' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    orders_of_500_and_700 = Order.where(amount: [500, 700]).all
    orders_of_700_and_1000 = Order.where(amount: [700, 1000]).all
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    orders_between_700_and_1000 = Order.orders_between("amount", 700, 1000)
    # ------------------------------------------------------------
  ...
  it '8. finds orders with an amount less than 550' do
    ...
    orders_less_than_550 = Order.less_than(:amount, 550)
    # ------------------------------------------------------------
